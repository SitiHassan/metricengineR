...
testthat::test_that("calculate_count assigns count values correctly", {
...
testthat::test_that("calculate_count filters to value type code 1", {
...
testthat::test_that("calculate_count preserves missing count values", {
...
testthat::test_that("calculate_count works with custom column names", {
...
testthat::test_that("calculate_count rejects non-data-frame input", {
  
  testthat::expect_error(
    calculate_count(c(1, 2, 3)),
...
testthat::test_that("calculate_count errors when required columns are missing", {
...
testthat::test_that("calculate_count validates confidence_intervals_required", {
...
testthat::test_that("calculate_count stops when confidence intervals are required", {
